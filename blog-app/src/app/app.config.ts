...
import { provideRouter, withComponentInputBinding, withEnabledBlockingInitialNavigation } from '@angular/router'; // Added withComponentInputBinding & withEnabledBlockingInitialNavigation
